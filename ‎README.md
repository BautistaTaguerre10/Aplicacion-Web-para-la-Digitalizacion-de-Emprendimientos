...
descargar la version mas reciente de nodejs usando el siguiente comando:
npm install

luego ejecutar el siguiente comando:
npm run dev 

los redirga a un localhost:3000 o localhost:3000/login
y listo se crean un usuario y se loguea luego empizan a usar la app web 


 
## prograr el programa en la web 
ir al sigieute sitio web https://eymitiendaweb.com/ 
y usar este usario de prubas para probar el programa:

usuario: pruebas@eymitiendaweb.com
